...
namespace JudgeSystem.Common
{
    public static class GlobalConstants
    {
        ...
        #region Python related constants
        ...
        public static string EmailConfirmationMessage = "Hello, and welcome!<br/><br/>To complete your registration and get started, please confirm your account.<br/><br/>You can do this by <a href='{0}'>clicking here</a>.<br/><br/>Thank you and welcome aboard!";
